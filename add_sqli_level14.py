...
def add_sqli_level14_route():
    """Add the SQL Injection Level 14 route to app.py"""
    # Find the end of the sqli_level13 function
    ...
    # Add the sqli_level14 function after sqli_level13
    new_route = '''
...
'''
    ...
    updated_content = content[:sqli_level13_end + 1] + new_route + content[sqli_level13_end + 1:]
    
    # Write the updated content back to app.py
    with open('app.py', 'w') as f:
        f.write(updated_content)
    
    print("Added SQL Injection Level 14 route to app.py")

if __name__ == '__main__':
    add_sqli_level14_route()
