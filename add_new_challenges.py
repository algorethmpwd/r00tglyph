    ...
    with app.app_context():
        ...
        new_challenges = [
            ...
            },
            {
                ...
                'category': 'SQL Injection',
                'description': 'Exploit SQL injection vulnerabilities in GraphQL API resolvers to access sensitive data.',
                'difficulty': 'Expert',
                'points': 400
            },
            {
                ...
                'category': 'SQL Injection',
                'description': 'Discover and exploit injection vulnerabilities in NoSQL databases.',
                'difficulty': 'Expert',
                'points': 400
            },
            {
                ...
                'category': 'SQL Injection',
                'description': 'Exploit SQL injection vulnerabilities in Object-Relational Mapping (ORM) layers.',
                'difficulty': 'Expert',
                'points': 400
            }
        ]
