...
# Check for command-line arguments (only when run directly, not when imported)
_running_directly = __name__ == "__main__" or (
    len(sys.argv) > 0 and sys.argv[0].endswith("app.py")
)
args = None
if _running_directly and len(sys.argv) > 1:
    ...
    parser.add_argument(
        ...
        "--update",
        action="store_true",
        help="Update R00tGlyph to the latest version",
    )
    parser.add_argument("--backup", action="store_true", help="Backup user data only")
    parser.add_argument(
        "--restore", action="store_true", help="Restore user data from backup"
    )
    parser.add_argument(
        "--reset", action="store_true", help="Reset the database to its initial state"
    )
    parser.add_argument(
        "-p", "--port", type=int, default=None, help="Port to bind to (default: 5000)"
    )
    ...
    if args and args.backup:
        backup_user_data()
        sys.exit(0)

    # Handle restore command
    if args and args.restore:
        restore_user_data()
        sys.exit(0)
...
app.secret_key = os.environ.get(
    "SECRET_KEY", "r00tglyph_secret_key_change_in_production"
)
    ...
    with app.app_context():
        ...
        challenges = [
            ...
            Challenge(
                ...
                category="sqli",
                difficulty="beginner",
                description="Exploit SQL injection in search functionality.",
                points=200,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="intermediate",
                description="Use UNION-based SQL injection techniques.",
                points=300,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="intermediate",
                description="Exploit blind SQL injection vulnerabilities.",
                points=400,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="intermediate",
                description="Use time-based techniques for blind SQL injection.",
                points=500,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="advanced",
                description="Bypass WAF protection to exploit SQL injection.",
                points=600,
            ),
            Challenge(
            ...
            Challenge(
                ...
                category="sqli",
                difficulty="advanced",
                description="Exploit second-order SQL injection vulnerabilities.",
                points=800,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="advanced",
                description="Find SQL injection in REST API endpoints.",
                points=900,
            ),
            Challenge(
            ...
            Challenge(
                ...
                category="sqli",
                difficulty="expert",
                description="Exploit SQL injection in GraphQL queries.",
                points=1100,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="expert",
                description="Exploit SQL injection in ORM frameworks.",
                points=1200,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="expert",
                description="Use out-of-band techniques for data exfiltration.",
                points=1300,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="expert",
                description="Advanced WAF bypass techniques for SQL injection.",
                points=1400,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="expert",
                description="Exploit SQL injection through XML processing.",
                points=1500,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="expert",
                description="Find SQL injection in WebSocket connections.",
                points=1600,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="expert",
                description="Exploit SQL injection in mobile app backends.",
                points=1700,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="expert",
                description="Find SQL injection in serverless cloud functions.",
                points=1800,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="expert",
                description="Exploit SQL injection through file upload functionality.",
                points=1900,
            ),
            Challenge(
                ...
                category="sqli",
                difficulty="expert",
                description="Exploit SQL injection in stored procedures.",
                points=2000,
            ),
            Challenge(
                name="SQL Injection in GraphQL API",
                category="sqli",
                difficulty="expert",
                description="Advanced GraphQL injection techniques.",
                points=2100,
            ),
            Challenge(
                name="SQL Injection in NoSQL Database",
                category="sqli",
                difficulty="expert",
                description="Exploit injection vulnerabilities in NoSQL databases.",
                points=2200,
            ),
            Challenge(
                name="SQL Injection in ORM Layer",
                category="sqli",
                difficulty="expert",
                description="Advanced ORM injection and bypass techniques.",
                points=2300,
            ),
            ...
            Challenge(
                ...
                category="cmdi",
                difficulty="beginner",
                description="Find and exploit a basic command injection vulnerability.",
                points=100,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="beginner",
                description="Bypass basic command injection filters.",
                points=200,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="intermediate",
                description="Exploit a blind command injection vulnerability.",
                points=300,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="intermediate",
                description="Exploit command injection through file upload functionality.",
                points=400,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="intermediate",
                description="Find command injection in API parameters.",
                points=500,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="advanced",
                description="Bypass WAF protection to exploit command injection.",
                points=600,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="advanced",
                description="Exploit time-based blind command injection.",
                points=700,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="advanced",
                description="Exploit command injection in log processing systems.",
                points=800,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="advanced",
                description="Find command injection vulnerabilities in JSON APIs.",
                points=900,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="advanced",
                description="Exploit command injection in XML processing.",
                points=1000,
            ),
            Challenge(
                name="Advanced Command Injection WAF Bypass",
                category="cmdi",
                difficulty="expert",
                description="Advanced WAF bypass techniques for command injection.",
                points=1100,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="expert",
                description="Exploit command injection in DevOps automation tools.",
                points=1200,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="expert",
                description="Find command injection in GraphQL API implementations.",
                points=1300,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="expert",
                description="Exploit command injection through WebSocket connections.",
                points=1400,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="expert",
                description="Exploit command injection in serverless function environments.",
                points=1500,
            ),
            Challenge(
                name="Advanced Shell Features Command Injection",
                category="cmdi",
                difficulty="expert",
                description="Exploit advanced shell features for command injection.",
                points=1600,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="expert",
                description="Exploit command injection in containerized applications.",
                points=1700,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="expert",
                description="Exploit command injection through template engines.",
                points=1800,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="expert",
                description="Find command injection in message queue systems.",
                points=1900,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="expert",
                description="Exploit out-of-band command injection techniques.",
                points=2000,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="expert",
                description="Exploit command injection in cloud function platforms.",
                points=2100,
            ),
            Challenge(
                name="Command Injection in SSH Commands",
                category="cmdi",
                difficulty="expert",
                description="Exploit command injection in SSH command execution.",
                points=2200,
            ),
            Challenge(
                ...
                category="cmdi",
                difficulty="expert",
                description="Chain multiple command injection techniques for maximum impact.",
                points=2300,
            ),
            ...
            Challenge(
                ...
                category="xxe",
                difficulty="beginner",
                description="Exploit a basic XXE vulnerability to read local files.",
                points=100,
            ),
            Challenge(
                name="XXE with DOCTYPE Restrictions",
                category="xxe",
                difficulty="beginner",
                description="Bypass basic DOCTYPE restrictions in XXE attacks.",
                points=200,
            ),
            Challenge(
                name="XXE SYSTEM Entity Exploitation",
                category="xxe",
                difficulty="beginner",
                description="Use SYSTEM entities to access forbidden files.",
                points=300,
            ),
            Challenge(
                name="XXE Internal Network Scanning",
                category="xxe",
                difficulty="intermediate",
                description="Use XXE to scan internal network services.",
                points=400,
            ),
            Challenge(
                name="XXE Data Exfiltration via HTTP",
                category="xxe",
                difficulty="intermediate",
                description="Exfiltrate sensitive data using HTTP-based XXE.",
                points=500,
            ),
            Challenge(
                ...
                category="xxe",
                difficulty="intermediate",
                description="Exploit XXE using parameter entities for advanced attacks.",
                points=600,
            ),
            Challenge(
                name="Blind XXE via Error Messages",
                category="xxe",
                difficulty="intermediate",
                description="Exploit blind XXE vulnerabilities through error-based techniques.",
                points=700,
            ),
            Challenge(
                name="XXE with CDATA Injection",
                category="xxe",
                difficulty="intermediate",
                description="Use CDATA sections to bypass XXE filters.",
                points=800,
            ),
            Challenge(
                ...
                category="xxe",
                difficulty="advanced",
                description="Exploit XXE through malicious SVG file uploads.",
                points=900,
            ),
            Challenge(
                name="XXE with XInclude Attacks",
                category="xxe",
                difficulty="advanced",
                description="Perform XXE attacks using XInclude directives.",
                points=1000,
            ),
            Challenge(
                ...
                category="xxe",
                difficulty="advanced",
                description="Perform denial of service attacks through entity expansion.",
                points=1100,
            ),
            Challenge(
                name="XXE SSRF Combination Attack",
                category="xxe",
                difficulty="advanced",
                description="Combine XXE with SSRF for advanced exploitation.",
                points=1200,
            ),
            Challenge(
                name="XXE with WAF Bypass Techniques",
                category="xxe",
                difficulty="advanced",
                description="Bypass Web Application Firewalls to exploit XXE.",
                points=1300,
            ),
            Challenge(
                name="XXE via SOAP Web Services",
                category="xxe",
                difficulty="expert",
                description="Exploit XXE vulnerabilities in SOAP-based web services.",
                points=1400,
            ),
            Challenge(
                name="Advanced XXE with OOB Data Retrieval",
                category="xxe",
                difficulty="expert",
                description="Use out-of-band techniques for XXE data exfiltration.",
                points=1500,
            ),
            Challenge(
                name="XXE in JSON-XML Conversion",
                category="xxe",
                difficulty="expert",
                description="Exploit XXE in applications that convert JSON to XML.",
                points=1600,
            ),
            Challenge(
                name="XXE with Custom Entity Resolvers",
                category="xxe",
                difficulty="expert",
                description="Bypass custom entity resolvers and security controls.",
                points=1700,
            ),
            Challenge(
                name="XXE in Microsoft Office Documents",
                category="xxe",
                difficulty="expert",
                description="Exploit XXE vulnerabilities in Office document processing.",
                points=1800,
            ),
            Challenge(
                name="XXE with Protocol Handler Exploitation",
                category="xxe",
                difficulty="expert",
                description="Exploit various protocol handlers through XXE attacks.",
                points=1900,
            ),
            Challenge(
                name="XXE in XML Signature Verification",
                category="xxe",
                difficulty="expert",
                description="Exploit XXE in XML digital signature verification processes.",
                points=2000,
            ),
            Challenge(
                name="XXE with Time-Based Blind Techniques",
                category="xxe",
                difficulty="expert",
                description="Use time-based techniques for blind XXE exploitation.",
                points=2100,
            ),
            Challenge(
                name="XXE in Cloud XML Processing",
                category="xxe",
                difficulty="expert",
                description="Exploit XXE vulnerabilities in cloud-based XML processing services.",
                points=2200,
            ),
            Challenge(
                name="Advanced XXE Attack Chaining",
                category="xxe",
                difficulty="expert",
                description="Chain multiple XXE techniques for maximum exploitation impact.",
                points=2300,
            ),
            ...
            Challenge(
                ...
                category="ssrf",
                difficulty="beginner",
                description="Find and exploit a basic SSRF vulnerability.",
                points=100,
            ),
            Challenge(
                name="SSRF with Internal Network Scanning",
                category="ssrf",
                difficulty="beginner",
                description="Use SSRF to scan internal network services.",
                points=200,
            ),
            Challenge(
            ...
            Challenge(
                name="Blind SSRF with DNS Exfiltration",
                category="ssrf",
                difficulty="intermediate",
                description="Exploit blind SSRF using DNS exfiltration techniques.",
                points=400,
            ),
            Challenge(
                name="SSRF with Basic Filters",
                category="ssrf",
                difficulty="intermediate",
                description="Bypass basic SSRF protection filters.",
                points=500,
            ),
            Challenge(
                name="SSRF via File Upload",
                category="ssrf",
                difficulty="advanced",
                description="Exploit SSRF through image processing vulnerabilities.",
                points=600,
            ),
            Challenge(
                name="SSRF in Webhooks",
                category="ssrf",
                difficulty="advanced",
                description="Exploit SSRF in webhook URL validation.",
                points=700,
            ),
            Challenge(
                name="SSRF with WAF Bypass",
                category="ssrf",
                difficulty="advanced",
                description="Bypass WAF protection to exploit SSRF.",
                points=800,
            ),
            Challenge(
                name="SSRF via XXE",
                category="ssrf",
                difficulty="expert",
                description="Chain XXE with SSRF for internal network access.",
                points=900,
            ),
            Challenge(
                ...
                category="ssrf",
                difficulty="expert",
                description="Use DNS rebinding attacks to bypass SSRF protections.",
                points=1000,
            ),
            Challenge(
                name="SSRF in GraphQL",
                category="ssrf",
                difficulty="expert",
                description="Exploit SSRF vulnerabilities in GraphQL introspection.",
                points=1100,
            ),
            Challenge(
                name="SSRF via Redis Protocol",
                category="ssrf",
                difficulty="expert",
                description="Use Gopher protocol to exploit Redis via SSRF.",
                points=1200,
            ),
            Challenge(
                name="SSRF in WebSocket Upgrade",
                category="ssrf",
                difficulty="expert",
                description="Exploit SSRF during WebSocket connection upgrades.",
                points=1300,
            ),
            Challenge(
                name="SSRF via SMTP Protocol",
                category="ssrf",
                difficulty="expert",
                description="Use SSRF to interact with internal SMTP servers.",
                points=1400,
            ),
            Challenge(
                name="SSRF in OAuth Callbacks",
                category="ssrf",
                difficulty="expert",
                description="Exploit SSRF in OAuth redirect URI validation.",
                points=1500,
            ),
            Challenge(
                name="SSRF via LDAP Protocol",
                category="ssrf",
                difficulty="expert",
                description="Use SSRF to query internal LDAP directories.",
                points=1600,
            ),
            Challenge(
                name="SSRF in Container Metadata",
                category="ssrf",
                difficulty="expert",
                description="Access Docker/Kubernetes metadata via SSRF.",
                points=1700,
            ),
            Challenge(
                name="SSRF via FTP Protocol",
                category="ssrf",
                difficulty="expert",
                description="Exploit internal FTP services through SSRF.",
                points=1800,
            ),
            Challenge(
                name="SSRF in API Gateway",
                category="ssrf",
                difficulty="expert",
                description="Exploit SSRF in API gateway configurations.",
                points=1900,
            ),
            Challenge(
                name="SSRF via Time-based Attacks",
                category="ssrf",
                difficulty="expert",
                description="Use timing attacks for blind SSRF exploitation.",
                points=2000,
            ),
            Challenge(
                name="SSRF in Microservices",
                category="ssrf",
                difficulty="expert",
                description="Exploit SSRF in microservice architectures.",
                points=2100,
            ),
            Challenge(
                name="SSRF via Protocol Smuggling",
                category="ssrf",
                difficulty="expert",
                description="Use protocol smuggling for advanced SSRF.",
                points=2200,
            ),
            Challenge(
                name="SSRF in Serverless Functions",
                category="ssrf",
                difficulty="expert",
                description="Exploit SSRF in serverless computing environments.",
                points=2300,
            ),
            ...
            Challenge(
                ...
                category="csrf",
                difficulty="beginner",
                description="Exploit a basic CSRF vulnerability in form submissions.",
                points=100,
            ),
            Challenge(
                name="GET-based CSRF",
                category="csrf",
                difficulty="beginner",
                description="Exploit CSRF in state-changing GET requests.",
                points=200,
            ),
            Challenge(
                name="JSON CSRF",
                category="csrf",
                difficulty="intermediate",
                description="Perform CSRF attacks with JSON payloads.",
                points=300,
            ),
            Challenge(
                name="File Upload CSRF",
                category="csrf",
                difficulty="intermediate",
                description="Exploit CSRF in file upload functionality.",
                points=400,
            ),
            Challenge(
                name="CSRF with Weak Tokens",
                category="csrf",
                difficulty="intermediate",
                description="Bypass weak CSRF token implementations.",
                points=500,
            ),
            Challenge(
                name="Referrer-based Protection Bypass",
                category="csrf",
                difficulty="intermediate",
                description="Bypass referrer header validation in CSRF protection.",
                points=600,
            ),
            Challenge(
                name="CSRF in AJAX Requests",
                category="csrf",
                difficulty="intermediate",
                description="Exploit CSRF in XMLHttpRequest and fetch API calls.",
                points=700,
            ),
            Challenge(
                ...
                category="csrf",
                difficulty="advanced",
                description="Bypass SameSite cookie protection mechanisms.",
                points=800,
            ),
            Challenge(
                ...
                category="csrf",
                difficulty="advanced",
                description="Bypass custom header-based CSRF protection.",
                points=900,
            ),
            Challenge(
                name="Multi-step CSRF",
                category="csrf",
                difficulty="advanced",
                description="Execute complex multi-step CSRF attack chains.",
                points=1000,
            ),
            Challenge(
                ...
                category="csrf",
                difficulty="advanced",
                description="Exploit CSRF in critical password change functionality.",
                points=1100,
            ),
            Challenge(
            ...
            Challenge(
                ...
                category="csrf",
                difficulty="expert",
                description="Combine CSRF with CORS misconfigurations.",
                points=1300,
            ),
            Challenge(
                name="WebSocket CSRF",
            ...
            Challenge(
                ...
                category="csrf",
                difficulty="expert",
                description="Chain XSS and CSRF for advanced exploitation.",
                points=1700,
            ),
            Challenge(
                name="GraphQL CSRF",
            ...
            Challenge(
                ...
                category="csrf",
                difficulty="expert",
                description="Exploit CSRF with JWT token manipulation.",
                points=1900,
            ),
            Challenge(
                ...
                category="csrf",
                difficulty="expert",
                description="Exploit CSRF in mobile application APIs.",
                points=2000,
            ),
            Challenge(
            ...
            Challenge(
                ...
                category="csrf",
                difficulty="expert",
                description="Combine subdomain takeover with CSRF exploitation.",
                points=2200,
            ),
            Challenge(
                ...
                category="csrf",
                difficulty="expert",
                description="Exploit CSRF in serverless computing environments.",
                points=2300,
            ),
            # SSTI Challenges
            Challenge(
                ...
                category="ssti",
                difficulty="beginner",
                description="Basic Server-Side Template Injection vulnerability.",
                points=100,
            ),
            Challenge(
                name="SSTI Level 2",
                category="ssti",
                difficulty="beginner",
                description="SSTI with basic filtering.",
                points=200,
            ),
            Challenge(
                name="SSTI Level 3",
                category="ssti",
                difficulty="intermediate",
                description="SSTI with advanced filtering.",
                points=300,
            ),
            Challenge(
                name="SSTI Level 4",
            ...
            Challenge(
                ...
                category="ssti",
                difficulty="advanced",
                description="SSTI with sandbox escape.",
                points=500,
            ),
            Challenge(
                name="SSTI Level 6",
                category="ssti",
                difficulty="advanced",
                description="SSTI to Remote Code Execution.",
                points=600,
            ),
            Challenge(
                name="SSTI Level 7",
                category="ssti",
                difficulty="advanced",
                description="Blind SSTI exploitation.",
                points=700,
            ),
            Challenge(
                name="SSTI Level 8",
                category="ssti",
                difficulty="expert",
                description="SSTI in Twig templates.",
                points=800,
            ),
            Challenge(
                name="SSTI Level 9",
                category="ssti",
                difficulty="expert",
                description="SSTI with WAF bypass.",
                points=900,
            ),
            Challenge(
                name="SSTI Level 10",
                category="ssti",
                difficulty="expert",
                description="SSTI in Freemarker templates.",
                points=1000,
            ),
            Challenge(
                name="SSTI Level 11",
                category="ssti",
                difficulty="expert",
                description="SSTI in Velocity templates.",
                points=1100,
            ),
            Challenge(
                name="SSTI Level 12",
                category="ssti",
                difficulty="expert",
                description="SSTI with object injection.",
                points=1200,
            ),
            Challenge(
                name="SSTI Level 13",
                category="ssti",
                difficulty="expert",
                description="SSTI in Smarty templates.",
                points=1300,
            ),
            Challenge(
                name="SSTI Level 14",
                category="ssti",
                difficulty="expert",
                description="SSTI with encoding bypass.",
                points=1400,
            ),
            Challenge(
                name="SSTI Level 15",
                category="ssti",
                difficulty="expert",
                description="SSTI in Mako templates.",
                points=1500,
            ),
            Challenge(
                name="SSTI Level 16",
                category="ssti",
                difficulty="expert",
                description="SSTI with custom filters.",
                points=1600,
            ),
            Challenge(
                name="SSTI Level 17",
                category="ssti",
                difficulty="expert",
                description="SSTI in Pebble templates.",
                points=1700,
            ),
            Challenge(
                name="SSTI Level 18",
                category="ssti",
                difficulty="expert",
                description="SSTI with attribute access restrictions.",
                points=1800,
            ),
            Challenge(
                name="SSTI Level 19",
                category="ssti",
                difficulty="expert",
                description="SSTI in Jade/Pug templates.",
                points=1900,
            ),
            Challenge(
                name="SSTI Level 20",
                category="ssti",
                difficulty="expert",
                description="SSTI with multiple template engines.",
                points=2000,
            ),
            Challenge(
                name="SSTI Level 21",
                category="ssti",
                difficulty="expert",
                description="SSTI in EJS templates.",
                points=2100,
            ),
            Challenge(
                name="SSTI Level 22",
                category="ssti",
                difficulty="expert",
                description="SSTI with prototype pollution.",
                points=2200,
            ),
            Challenge(
                name="SSTI Level 23",
                category="ssti",
                difficulty="expert",
                description="Advanced SSTI with chained exploits.",
                points=2300,
            ),
            # Deserialization Challenges
            Challenge(
                name="Deserialization Level 1",
                category="deserial",
                difficulty="beginner",
                description="Basic insecure deserialization in Python pickle.",
                points=100,
            ),
            Challenge(
                name="Deserialization Level 2",
                category="deserial",
                difficulty="intermediate",
            ...
            Challenge(
                name="Deserialization Level 3",
                category="deserial",
                difficulty="advanced",
                description="Java deserialization with gadget chains.",
                points=500,
            ),
            Challenge(
                name="Deserialization Level 4",
                category="deserial",
                difficulty="expert",
                description=".NET deserialization vulnerability.",
                points=700,
            ),
            Challenge(
                name="Deserialization Level 5",
                category="deserial",
                difficulty="expert",
            ...
            Challenge(
                ...
                category="auth",
                difficulty="beginner",
                description="Basic authentication bypass via SQL injection.",
                points=100,
            ),
            Challenge(
                name="Auth Bypass Level 2",
                category="auth",
                difficulty="intermediate",
            ...
            Challenge(
                name="Auth Bypass Level 3",
                category="auth",
                difficulty="advanced",
                description="Session fixation and hijacking.",
                points=500,
            ),
            Challenge(
                name="Auth Bypass Level 4",
                category="auth",
                difficulty="expert",
                description="OAuth/OIDC misconfiguration exploitation.",
                points=700,
            ),
            Challenge(
                name="Auth Bypass Level 5",
                category="auth",
                difficulty="expert",
...
def register():
    if request.method == "POST":
        ...
        new_user = LocalUser(
            username=username, display_name=username, password_hash=hashed_password
        )
...
def get_or_create_flag(challenge_id, user_id):
    ...
    existing_flag = Flag.query.filter_by(
        challenge_id=challenge_id, user_id=user_id, used=False
    ).first()
    ...
    new_flag = Flag(
        challenge_id=challenge_id, user_id=user_id, flag_value=new_flag_value
    )
    ...
    for sub in recent_submissions:
        ...
        if user and challenge:
            ...
            recent_activity.append({
                ...
                "type": "capture" if sub.correct else "attempt",
...
def submit_flag():
    ...
    valid_flag = Flag.query.filter_by(
        challenge_id=challenge_id, user_id=user_id, flag_value=flag, used=False
    ).first()
    ...
    if valid_flag:
        ...
        submission = Submission(
            user_id=user_id, challenge_id=challenge_id, flag=flag, correct=True
        )
        ...
        submission = Submission(
            user_id=user_id, challenge_id=challenge_id, flag=flag, correct=False
        )
        db.session.add(submission)
        db.session.commit()
...
def xss_level1():
    ...
    if (
        "<script>" in user_input
        or "javascript:" in user_input
        or "onerror=" in user_input
    ):
        xss_detected = True
...
def xss_level2():
    ...
    # Regular page render
    return render_template(
        "xss/xss_level2.html", flag=flag, xss_detected=xss_detected, challenge=challenge
    )
...
def xss_level3():
    ...
    if request.method == "POST":
        ...
        new_comment = Comment(
            username=username, content=content, level=3, user_id=user.id
        )
...
def xss_level7():
    ...
    if (
        ...
        or "javascript:" in user_agent
        or "onerror=" in user_agent
    ):
        xss_detected = True
...
def xss_level9():
    ...
    if request.method == "POST":
        ...
        if (
            'alert("XSS Level 9 Completed!")' in user_comment
            or "alert('XSS Level 9 Completed!')" in user_comment
        ):
            xss_detected = True
    ...
    response.headers["Content-Security-Policy"] = (
        "default-src 'self'; script-src 'self' https://cdnjs.cloudflare.com; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net; img-src 'self' https://via.placeholder.com data:;"
    )
...
def xss_level10():
    ...
    chat_messages = [
        {
            "user": "System",
            "message": "Welcome to SafeChat! This is a secure messaging platform.",
            "time": "10:00 AM",
        },
        {
            "user": "Admin",
            "message": "Please be aware that we sanitize all messages to prevent XSS attacks.",
            "time": "10:05 AM",
        },
        {
            "user": "User123",
            "message": "I tried to use <script>alert('test')</script> but it didn't work!",
            "time": "10:10 AM",
        },
        {
            "user": "Admin",
            "message": "That's right! Our Mutation Observer technology removes malicious code instantly.",
            "time": "10:15 AM",
        },
    ]
    ...
    if request.method == "POST":
        ...
        # Check for the intended XSS payload
        if (
            'alert("XSS Level 10 Completed!")' in user_message
            or "alert('XSS Level 10 Completed!')" in user_message
        ):
            xss_detected = True
            challenge = Challenge.query.filter_by(
                name="XSS with Mutation Observer Bypass"
...
def xss_level11():
    ...
    if request.method == "POST":
        ...
        filtered_svg = re.sub(
            r"<script[^>]*>.*?</script>", "", filtered_svg, flags=re.DOTALL
        )
        filtered_svg = re.sub(r'\son\w+=["\'][^"\'>]*["\']', "", filtered_svg)
        filtered_svg = re.sub(
            r'\s(?:href|xlink:href|src)=["\']javascript:[^"\'>]*["\']', "", filtered_svg
        )

        # Check for successful SVG XSS
        if (
            'alert("XSS Level 11 Completed!")' in svg_code
            or "alert('XSS Level 11 Completed!')" in svg_code
        ) and ("<svg" in svg_code):
            xss_detected = True
            # Mark challenge as completed
            challenge = Challenge.query.filter_by(name="XSS via SVG and CDATA").first()
...
def xss_level12():
    ...
    if request.method == "POST":
        ...
        if (
            ...
            or "javascript:" in description
            or "onerror=" in description
        ) and webhook_url:
            xss_detected = True
            # Mark challenge as completed
            challenge = Challenge.query.filter_by(
...
def xss_level13():
    ...
    if request.method == "POST":
        ...
        if (
            "app.alert" in resume_summary
            or "app.alert" in resume_skills
            or "app.alert" in resume_experience
        ):
            xss_detected = True
            # Mark challenge as completed
...
def xss_level14():
    ...
    if request.method == "POST":
        ...
        if "__proto__" in config_json and (
            "innerHTML" in config_json
            or "outerHTML" in config_json
            or "alert" in config_json
        ):
            xss_detected = True
            # Mark challenge as completed
            challenge = Challenge.query.filter_by(
            ...
            message = (
                "Try to use prototype pollution to trigger the alert as described."
            )
...
def xss_level15():
    ...
    if request.method == "POST":
        ...
        if (
            "constructor.constructor" in template_content
            or "eval(" in template_content
            or 'alert("XSS Level 15 Completed!")' in template_content
            or "alert('XSS Level 15 Completed!')" in template_content
        ):
            xss_detected = True
            # Mark challenge as completed
...
def sqli_level2():
    ...
    if search_term:
        ...
        products = [
            p for p in default_products if search_term.lower() in p["name"].lower()
        ]

        # If SQL injection is detected and specifically looking for product with ID 42
        if sqli_detected and (
            "42" in search_term
            or "id=42" in search_term.lower()
            or "id = 42" in search_term.lower()
        ):
        ...
        elif sqli_detected and (
            "1=1" in search_term.lower() or "or" in search_term.lower()
        ):
    ...
    users = [
        {
            "id": 1,
            "username": "admin",
            "password": "FLAG{uni0n_b4s3d_sql1_m4st3r}",
            "role": "admin",
            "created": 2023,
        }
    ]
...
def sqli_level4():
    ...
    hidden_users = {
        ...
        "42": {
            ...
            "password": "FLAG{bl1nd_sql1_3xtr4ct10n_pr0}",
        },
    }
    ...
    if user_id:
        ...
        if sqli_detected:
            ...
            # If the query is using blind SQL injection techniques to extract data
                ...
                "SUBSTRING" in user_id_upper
                or "ASCII" in user_id_upper
                or "MID" in user_id_upper
                or "CHAR" in user_id_upper
            ):
                user_exists = True
...
def sqli_level5():
    ...
    if request.method == "POST":
        ...
        if sqli_detected:
            ...
            if (
                "SLEEP" in email_upper
                or "BENCHMARK" in email_upper
                or "DELAY" in email_upper
                or "PG_SLEEP" in email_upper
                or "WAITFOR" in email_upper
            ):
...
def sqli_level7():
    ...
    if category_id:
        ...
        if sqli_detected:
            ...
            if (
                "CONCAT" in category_id_upper
                or "GROUP BY" in category_id_upper
                or "FLOOR" in category_id_upper
                or "RAND" in category_id_upper
                or "EXTRACTVALUE" in category_id_upper
                or "UPDATEXML" in category_id_upper
            ):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            for product in products:
                if (product["category"] == category or not category) and product[
                    "price"
                ] <= price:
        ...
        if department in default_employees:
            if sqli_detected:
                ...
                for employee in default_employees[department]:
                    if (
                        search_term.lower() in employee["name"].lower()
                        or search_term.lower() in employee["position"].lower()
                    ):
...
def sqli_level13():
    ...
    default_stocks = [
        ...
        {"symbol": "TSLA", "name": "Tesla, Inc.", "price": "237.49", "change": -1.45},
    ]
        ...
        if search_term:
            if sqli_detected:
                ...
                for stock in default_stocks:
                    if (
                        search_term.upper() in stock["symbol"].upper()
                        or search_term.lower() in stock["name"].lower()
                    ):
                        stocks.append(stock)
    ...
    if request.method == "POST":
        ...
        if waf_check(category) or waf_check(search_term):
            ...
            advanced_bypass_patterns = [
                "%27",
                "%2527",
                "%252527",  # URL encoded single quotes
                "un%69on",
                "un%69%6fn",
                "un%2569on",  # URL encoded UNION
                "se%6cect",
                "se%6c%65ct",
                "se%2565ct",  # URL encoded SELECT
                "concat(0x",
                "char(",
                "hex(",  # Alternative string functions
                "0x3",
                "0x4",
                "0x5",  # Hex values
...
def sqli_level15():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            report_type = (
                root.find("type").text if root.find("type") is not None else ""
            )
            report_period = (
                root.find("period").text if root.find("period") is not None else ""
            )
            report_department = (
                root.find("department").text
                if root.find("department") is not None
                else ""
            )
            ...
            for pattern in sqli_patterns:
                if (
                    pattern in report_type
                    or pattern in report_period
                    or pattern in report_department
                ):
                    # SQL injection detected!
                    sqli_detected = True
                    ...
                    reports = [
                        {
                            ...
                            "data": "Sales increased by 15% in Q1.",
                        },
                        {
                            "id": 2,
                            ...
                            "period": "quarterly",
                            "department": report_department,
                            "data": "Sales increased by 10% in Q2.",
                        },
                    ]
                    ...
                    reports = [
                        {
                            ...
                            "department": report_department,
                            "data": "Current inventory levels are optimal.",
                        },
                        {
                            "id": 4,
                            ...
                            "period": report_period,
                            "department": report_department,
                            "data": "Inventory forecast for next quarter is stable.",
                        },
                    ]
                    ...
                    reports = [
                        {
                            ...
                            "period": report_period,
                            "department": report_department,
                            "data": "Recent campaign resulted in 20% increase in leads.",
                        },
                        {
                            "id": 6,
                            ...
                            "period": report_period,
                            "department": report_department,
                            "data": "Marketing budget allocation for next quarter.",
                        },
                    ]
        except Exception as e:
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if not sqli_detected:
                ...
                api_response = json.dumps(
                    {"status": "success", "products": products}, indent=2
                )
    ...
    if request.method == "POST":
        ...
        try:
            ...
            function_logs.append(
                {
                    "timestamp": (
                        start_time + datetime.timedelta(milliseconds=50)
            ...
            function_logs.append(
                {
                    "timestamp": (
                        start_time + datetime.timedelta(milliseconds=100)
                    ).strftime("%Y-%m-%d %H:%M:%S.%f")[:-3],
                    "level": "info",
            ...
            for pattern in sqli_patterns:
                if pattern in dataset or pattern in filter_condition:
                    ...
                    function_logs.append(
                        {
                            "timestamp": (
                                start_time + datetime.timedelta(milliseconds=150)
                            ).strftime("%Y-%m-%d %H:%M:%S.%f")[:-3],
                            "level": "warning",
        ...
        if csv_content:
            try:
                ...
                if len(csv_rows) > 0:
                    ...
                    if len(header) >= len(expected_columns) and all(
                        col.lower() == expected_columns[i].lower()
                        for i, col in enumerate(header[: len(expected_columns)])
                    ):
                        # Process each row
                        for i, row in enumerate(data_rows):
                            if len(row) >= len(expected_columns):
                                ...
                                for pattern in sqli_patterns:
                                    if (
                                        pattern in id_val
                                        or pattern in name_val
                                        or pattern in email_val
                                        or pattern in department_val
                                    ):
                                        # SQL injection detected!
                                        sqli_detected = True
                                        ...
                                        import_errors.append(
                                            f"Error in row {i + 1}: SQL syntax error"
                                        )
                                ...
                                import_errors.append(
                                    f"Error in row {i + 1}: Insufficient columns"
                                )
...
def sqli_level20():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            generated_sql = (
                f"SELECT * FROM products WHERE category = '{category}' AND active = 1"
            )
                ...
                if pattern in category or pattern in search_term:
                    ...
                    if "system_flags" in generated_sql:
                        result_rows = [
                            [
                                1,
                                "R00T{st0r3d_pr0c3dur3_sql1_1nj3ct10n_pwn3d}",
                                "2023-01-01 00:00:00",
                                "true",
                            ]
                        ]
...
def sqli_level21():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            # Check if any SQL injection pattern is in the input
            for pattern in sqli_patterns:
                if pattern in graphql_query and admin_secrets_pattern.search(
                    graphql_query
                ):
                    # SQL injection detected!
                    sqli_detected = True
            ...
            if not sqli_detected:
                if "user" in graphql_query:
                    ...
                    graphql_result = json.dumps(
                        {"errors": [{"message": "Unknown query type"}]}, indent=2
                    )
    ...
    if request.method == "POST":
        try:
            ...
            operator_pattern = re.compile(
                r"\$where|\$lookup|\$function|\$expr", re.IGNORECASE
            )

            # Check if the collection is 'secrets' or if the query contains suspicious patterns
            if (
                collection == "secrets"
                or secrets_pattern.search(query_str)
                or operator_pattern.search(query_str)
            ):
                # NoSQL injection detected!
                sqli_detected = True
            ...
            # If no NoSQL injection detected, return normal results
                ...
                if collection == "articles":
                    ...
                    if "username" in query_obj and query_obj["username"] == "johndoe":
                        ...
                        "username" in query_obj and query_obj["username"] == "janesmith"
                    ):
                        results = [
                            {
                                "_id": "2",
                    ...
                    if (
                        "category" in query_obj
                        and query_obj["category"] == "Electronics"
                    ):
                        results = [
                            {
                                "_id": "1",
                        ...
                        "category" in query_obj and query_obj["category"] == "Clothing"
                    ):
                        results = [
                            {
                                "_id": "3",
        ...
        try:
            ...
            for pattern in sqli_patterns:
                if pattern in search_term or pattern in filter_by or pattern in sort_by:
                    ...
                    # Return the flag
                    if (
                        "admin_flag" in search_term
                        or "admin_flag" in filter_by
                        or "admin_flag" in sort_by
                    ):
                        results = [
                            {
                                "id": 999,
            ...
            if not sqli_detected:
                ...
                if sort_by == "id":
                    ...
                    results.sort(
                        key=lambda x: x["title"], reverse=(sort_order == "desc")
                    )
                elif sort_by == "author":
                    results.sort(
                        key=lambda x: x["author"], reverse=(sort_order == "desc")
                    )
...
def solutions(level):
    ...
    if level.startswith("cmdi"):
        ...
        challenge = (
            Challenge.query.filter_by(name=challenge_name).first()
            if challenge_name
            else None
        )
        ...
        return render_template(
            f"solutions/cmdi_level{level_num}_solution.html", challenge=challenge
        )
    # Check if it's an SSRF solution
        ...
        return render_template(
            f"solutions/ssrf_level{level_num}_solution.html", challenge=challenge
        )
    # Check if it's an SQLi solution
        ...
        return render_template(
            f"solutions/sqli_level{level_num}_solution.html", challenge=challenge
        )
    ...
    # Check if it's an XXE solution
        ...
        return render_template(
            f"solutions/xxe_level{level_num}_solution.html", challenge=challenge
        )
    ...
    # Check if it's a CSRF solution
        ...
        return render_template(
            f"solutions/csrf_level{level_num}_solution.html", challenge=challenge
        )
    else:
        ...
        try:
            ...
            return render_template(
                f"solutions/xss_level{level}_solution.html", challenge=challenge
            )
        except ValueError:
...
def cmdi_level1():
    ...
    return render_template(
        "cmdi/cmdi_level1.html",
        flag=flag,
        cmdi_detected=cmdi_detected,
        hostname=hostname,
            ...
            for pattern in cmdi_patterns:
                if pattern in hostname:
                    ...
                    if "sleep" in hostname:
                        ...
                        try:
                            sleep_duration = int(
                                hostname.split("sleep")[1].strip().split()[0]
                            )
                            time.sleep(
                                min(sleep_duration, 10)
                            )  # Cap at 10 seconds for safety
                        except:
                            time.sleep(
                                2
...
def cmdi_level9():
    ...
    flag = None
    cmdi_detected = False
    build_config = request.form.get(
        "build_config", '{"branch": "main", "environment": "production"}'
    )
    build_result = ""
    ...
    if request.method == "POST":
        ...
        if build_config:
            try:
                        ...
                        for pattern in cmdi_patterns:
                            if pattern in value:
                                ...
                                if "uname" in value:
                                    ...
                                    build_result += (
                                        "Linux buildserver 5.4.0-74-generic\n"
                                    )
                ...
                if not cmdi_detected:
                    build_result = (
                        f"Starting build for branch: {config.get('branch', 'main')}\n"
                    )
...
def cmdi_level11():
    ...
    flag = None
    cmdi_detected = False
    xml_config = request.form.get(
        "xml_config",
        '<?xml version="1.0"?><config><service>web</service><action>restart</action></config>',
    )
    processing_result = ""
...
def cmdi_level13():
    ...
    flag = None
    cmdi_detected = False
    graphql_query = request.form.get(
        "graphql_query", 'query { systemInfo(hostname: "localhost") { status } }'
    )
    query_result = ""
...
def cmdi_level14():
    ...
    flag = None
    cmdi_detected = False
    websocket_message = request.form.get(
        "websocket_message",
        '{"type": "monitor", "target": "server1", "action": "status"}',
    )
    monitoring_result = ""
        ...
        if websocket_message:
            try:
                ...
                if not cmdi_detected:
                    monitoring_result = "WebSocket connection established\n"
                    monitoring_result += (
                        f"Processing message type: {message.get('type', 'unknown')}\n"
                    )
...
def cmdi_level15():
    ...
    flag = None
    cmdi_detected = False
    function_payload = request.form.get(
        "function_payload",
        '{"event": "process_data", "input": "sample.txt", "options": "--format json"}',
    )
    lambda_result = ""
        ...
        if function_payload:
            try:
                        ...
                        for pattern in cmdi_patterns:
                            if pattern in value:
                                ...
                                if "env" in value or "printenv" in value:
                                    ...
                                    lambda_result += (
                                        "SECRET_FLAG=R00T{s3rv3rl3ss_cmd1_pwn3d}\n"
                                    )
                ...
                if not cmdi_detected:
                    lambda_result = "AWS Lambda Function Execution\n"
                    lambda_result += (
                        f"Processing event: {payload.get('event', 'unknown')}\n"
                    )
...
def cmdi_level16():
    ...
    script_params = request.form.get(
        "script_params", "--target production --format tar.gz"
    )
    execution_result = ""
        ...
        if automation_script and script_params:
            ...
            for pattern in advanced_patterns:
                if pattern in automation_script or pattern in script_params:
                    cmdi_detected = True
                    execution_result = (
                        f"Executing automation script: {automation_script.split()[0]}\n"
                    )
...
def cmdi_level17():
    ...
    container_cmd = request.form.get(
        "container_cmd", "/bin/sh -c \"nginx -g 'daemon off;'\""
    )
    docker_result = ""
        ...
        if container_image and container_cmd:
            ...
            for pattern in cmdi_patterns:
                if pattern in container_image or pattern in container_cmd:
                    cmdi_detected = True
                    docker_result = (
                        f"Creating container from image: {container_image.split()[0]}\n"
                    )
...
def cmdi_level18():
    ...
    report_template = request.form.get(
        "report_template", "Report for {{customer_name}} generated on {{date}}"
    )
    template_data = request.form.get(
        "template_data", '{"customer_name": "Acme Corp", "date": "2024-12-19"}'
    )
    report_result = ""
    ...
    if request.method == "POST":
        ...
        if report_template and template_data:
            try:
                ...
                template_vulnerable = any(
                    pattern in report_template for pattern in ssti_patterns
                )
                data_vulnerable = any(
                    any(pattern in str(value) for pattern in cmdi_patterns)
                ...
                if template_vulnerable or data_vulnerable:
                    ...
                    if "__import__" in report_template or "os" in report_template:
                        ...
                        report_result += (
                            "System access gained through template engine\n"
                        )
                    ...
                    safe_template = report_template.replace(
...
def cmdi_level19():
    ...
    flag = None
    cmdi_detected = False
    queue_message = request.form.get(
        "queue_message",
        '{"task": "process_file", "filename": "data.csv", "options": "--format json"}',
    )
    processing_result = ""
                    ...
                    if isinstance(value, str):
                        for pattern in cmdi_patterns:
                            if pattern in value:
                                ...
                                processing_result += (
                                    f"Task: {message.get('task', 'unknown')}\n"
                                )
                                ...
                                if "uname" in value or "hostname" in value:
                                    ...
                                    processing_result += (
                                        "Worker hostname: task-worker-03\n"
                                    )
                                    processing_result += (
                                        "Worker OS: Linux 5.15.0-72-generic\n"
                                    )
...
def cmdi_level21():
    ...
    flag = None
    cmdi_detected = False
    function_code = request.form.get(
        "function_code",
            ...
            for pattern in cmdi_patterns:
                if pattern in function_code:
                    ...
                    if "os.system" in function_code or "subprocess" in function_code:
                        ...
                        cloud_result += (
                            "Service account: cloud-function-sa@project.iam\n"
                        )
...
def cmdi_level23():
    ...
    flag = None
    cmdi_detected = False
    infrastructure_config = request.form.get(
        "infrastructure_config",
        '{"terraform": {"provider": "aws", "region": "us-east-1"}, "ansible": {"playbook": "deploy.yml", "inventory": "production"}}',
    )
    deployment_result = ""
        ...
        if infrastructure_config:
            try:
                ...
                if "terraform" in config:
                    ...
                    terraform_cmdi = any(
                        pattern in terraform_config for pattern in advanced_patterns
                    )
                ...
                if "ansible" in config:
                    ...
                    ansible_cmdi = any(
                        pattern in ansible_config for pattern in advanced_patterns
                    )
                ...
                if terraform_cmdi or ansible_cmdi:
                    ...
                    if terraform_cmdi:
                        ...
                        deployment_result += (
                            "Command injection in Terraform detected!\n\n"
                        )
                    ...
                    if ansible_cmdi:
                        ...
                        deployment_result += (
                            "Command injection in Ansible detected!\n\n"
                        )
        ...
        if notification_url:
            ...
            for pattern in internal_patterns:
                if pattern in notification_url.lower():
                    ssrf_detected = True
                    webhook_result = (
                        f"Sending payment notification to: {notification_url}\n"
                    )
...
def ssrf_level9():
                    ...
                    for pattern in internal_patterns:
                        if pattern in system_url.lower():
                            ...
                            if "file://" in system_url:
                                ...
                                xxe_result += (
                                    "Gopher protocol exploitation successful\n"
                                )
                            else:
    ...
    return render_template(
        "ssrf/ssrf_level9.html",
        flag=flag,
        ssrf_detected=ssrf_detected,
        xml_data=xml_data,
        xxe_result=xxe_result,
        challenge=challenge,
    )
...
def ssrf_level10():
    ...
    return render_template(
        "ssrf/ssrf_level10.html",
        flag=flag,
        ssrf_detected=ssrf_detected,
        target_domain=target_domain,
        rebinding_result=rebinding_result,
        challenge=challenge,
    )
...
def ssrf_level11():
    ...
    if request.method == "POST":
        ...
        if graphql_query:
            ...
            if "query" in graphql_query.lower() and (
                "http://" in graphql_query or "https://" in graphql_query
            ):
...
def ssrf_level13():
    ...
    if request.method == "POST":
        if websocket_url and upgrade_headers:
            ...
            if any(
                pattern in websocket_url.lower() or pattern in upgrade_headers.lower()
                for pattern in ssrf_patterns
            ):
                ssrf_detected = True
...
def ssrf_level21():
    ...
    if request.method == "POST":
        if service_name and mesh_endpoint:
            ...
            if any(
                pattern in mesh_endpoint.lower() or pattern in service_name.lower()
                for pattern in ssrf_patterns
            ):
                ssrf_detected = True
...
def ssrf_level22():
    ...
    if request.method == "POST":
        if smuggled_request and wrapper_protocol:
            ...
            if any(
                pattern in wrapper_protocol.lower()
                or pattern in smuggled_request.lower()
                for pattern in ssrf_patterns
            ):
                ssrf_detected = True
...
Try using advanced protocol smuggling techniques."""
    ...
    return render_template(
        ...
        smuggling_result=smuggling_result,
        challenge=challenge,
    )
...
def ssrf_level23():
    ...
    if request.method == "POST":
        if function_url and cloud_metadata:
            ...
            if any(
                pattern in cloud_metadata.lower() or pattern in function_url.lower()
                for pattern in ssrf_patterns
            ):
                ssrf_detected = True
...
Try targeting cloud metadata services."""
    ...
    return render_template(
        ...
        serverless_result=serverless_result,
        challenge=challenge,
    )
        ...
        if xml_content:
            try:
                ...
                if (
                    ...
                    and "SYSTEM" in xml_content
                    and "/etc/passwd" in xml_content
                ):
                    xxe_detected = True
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if (
                    "<!DOCTYPE" in xml_content.upper()
                    and not xml_content.upper().startswith("<!DOCTYPE HTML")
                ):
                    # Check for entity bypass techniques
                    if (
                        "&xxe;" in xml_content or "&#x" in xml_content
                    ) and "/etc/passwd" in xml_content:
                        xxe_detected = True
                        file_content = """root:x:0:0:root:/root:/bin/bash
daemon:x:1:1:daemon:/usr/sbin:/usr/sbin/nologin
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if "SYSTEM" in xml_content and (
                    "file://" in xml_content or "http://" in xml_content
                ):
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if "SYSTEM" in xml_content and (
                    "192.168." in xml_content
                    or "10.0." in xml_content
                    or "172.16." in xml_content
                ):
                    if any(
                        port in xml_content
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if "%" in xml_content and (
                    "<!ENTITY" in xml_content or "SYSTEM" in xml_content
                ):
                    if any(
                        param in xml_content
                        for param in ["%file", "%data", "%exfil", "%param"]
                    ):
                        xxe_detected = True
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if "SYSTEM" in xml_content and (
                    "nonexistent" in xml_content or "invalid" in xml_content
                ):
                    if any(
                        file_ref in xml_content
                        for file_ref in ["/etc/passwd", "/etc/shadow", "/etc/hosts"]
                    ):
                        xxe_detected = True
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if "<![CDATA[" in xml_content and (
                    "ENTITY" in xml_content or "SYSTEM" in xml_content
                ):
                    if any(
                        payload in xml_content for payload in ["]]>", "&", "file://"]
                    ):
                        xxe_detected = True
...
def xxe_level9():
    ...
    if request.method == "POST":
        xml_content = request.form.get("xml_content", "") or request.form.get(
            "svg_content", ""
        )
        ...
        if xml_content:
            try:
                ...
                if "<svg" in xml_content and (
                    "ENTITY" in xml_content or "SYSTEM" in xml_content
                ):
                    if any(
                        svg_element in xml_content
                        for svg_element in ["<text>", "<tspan>", "xmlns"]
                    ):
                        xxe_detected = True
        ...
        if xml_content:
            try:
                ...
                if "xi:include" in xml_content or "XInclude" in xml_content:
                    if any(
                        href in xml_content for href in ["href=", "file://", "/etc/"]
                    ):
                        xxe_detected = True
...
- Supported in XSLT and XPath contexts"""
    ...
    return render_template(
        ...
        xml_content=xml_content,
        parsed_content=parsed_content,
        xinclude_result=xinclude_result,
        challenge=challenge,
    )
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if entity_count >= 3 and (
                    "&lol" in xml_content or "&ha" in xml_content
                ):
                    if any(
                        pattern in xml_content
                        for pattern in ["&lol1;", "&lol2;", "&lol3;"]
                    ):
                        xxe_detected = True
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if "SYSTEM" in xml_content and any(
                    protocol in xml_content
                    for protocol in ["http://", "https://", "ftp://", "gopher://"]
                ):
                    if any(
                        target in xml_content
                        for target in [
                            "localhost",
                            "127.0.0.1",
                            "169.254.169.254",
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if any(
                    pattern in xml_content
                    for pattern in bypass_patterns + entity_variations
                ):
        ...
        if xml_content:
            try:
                ...
                if "SYSTEM" in xml_content and any(
                    ...
                    if any(
                        oob_indicator in xml_content
                        for oob_indicator in ["attacker.com", "collaborator", "burp"]
                    ):
                        xxe_detected = True
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if "ENTITY" in xml_content and "SYSTEM" in xml_content:
                    if any(
                        payload in xml_content
                        for payload in ["/etc/passwd", "/etc/shadow", "file://"]
                    ):
                        xxe_detected = True
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if "SYSTEM" in xml_content and any(
                    scheme in xml_content
                    for scheme in ["custom://", "app://", "internal://"]
                ):
                    if any(
                        bypass in xml_content
                        for bypass in ["resolver", "handler", "protocol"]
                    ):
                        xxe_detected = True
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if "SYSTEM" in xml_content and any(
                    protocol in xml_content for protocol in protocols
                ):
                    xxe_detected = True
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if "SYSTEM" in xml_content and any(
                    delay_indicator in xml_content
                    for delay_indicator in ["sleep", "timeout", "delay"]
                ):
                    if any(
                        file_ref in xml_content
                        for file_ref in ["/dev/random", "/etc/passwd", "http://"]
                    ):
                        xxe_detected = True
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if "SYSTEM" in xml_content and any(
                    indicator in xml_content for indicator in cloud_indicators
                ):
                    xxe_detected = True
    ...
    if request.method == "POST":
        ...
        if xml_content:
            try:
                ...
                if (
                    "SYSTEM" in xml_content
                    and len([p for p in advanced_patterns if p in xml_content.lower()])
                    >= 2
                ):
...
def csrf_level3():
    ...
    if request.method == "POST":
        ...
        if api_endpoint and json_payload:
            ...
            if any(
                pattern in json_payload.lower() or pattern in api_endpoint.lower()
        ...
        if "upload_file" in request.files:
            ...
            if file and file.filename:
                ...
                if any(
                    ...
                    or pattern in file_description.lower()
                    for pattern in csrf_patterns
                ):
                    csrf_detected = True
...
def csrf_level5():
    ...
    if request.method == "POST":
        ...
        if csrf_token and form_data and submit_action:
            ...
            if (
                any(weak in csrf_token.lower() for weak in weak_tokens)
                or len(csrf_token) < 10
            ):
                csrf_detected = True
...
def csrf_level6():
    ...
    if request.method == "POST":
        ...
        if referrer_url and target_action:
            ...
            if (
                any(pattern in referrer_url.lower() for pattern in bypass_patterns)
                or not actual_referrer
            ):
                csrf_detected = True
...
def csrf_level7():
    ...
    if request.method == "POST":
        ...
        if ajax_endpoint and request_method and ajax_data:
            ...
            if any(
                pattern in ajax_endpoint.lower() or pattern in ajax_data.lower()
                for pattern in csrf_patterns
            ):
                csrf_detected = True
    ...
    if request.method == "POST":
        ...
        if samesite_mode and navigation_type and csrf_payload:
            ...
            bypass_conditions = [
                ...
                (samesite_mode == "None"),
                (
                    "bypass" in csrf_payload.lower()
                    or "samesite" in csrf_payload.lower()
                ),
            ]
...
def csrf_level9():
    ...
    if request.method == "POST":
        ...
        if custom_header and header_value and api_action:
            ...
            if (
                any(pattern in header_value for pattern in bypass_patterns)
                or not actual_header
            ):
                csrf_detected = True
...
def csrf_level10():
    ...
    if request.method == "POST":
        ...
        if step_number and step_data and workflow_id:
            ...
            if any(
                pattern in step_data.lower() or pattern in workflow_id.lower()
...
def csrf_level11():
    ...
    if request.method == "POST":
        ...
        if current_password and new_password and confirm_password:
            ...
            if (
                any(pattern in new_password.lower() for pattern in csrf_patterns)
...
def csrf_level12():
    ...
    if request.method == "POST":
        ...
        if captcha_response and captcha_token and protected_action:
            ...
            if any(
                pattern in captcha_response.lower() or pattern in captcha_token.lower()
                for pattern in bypass_patterns
            ):
                csrf_detected = True
...
def csrf_level13():
    ...
    if request.method == "POST":
        ...
        if origin_header and cors_endpoint and credentials_mode:
            ...
            if any(
                pattern in origin_header.lower() or pattern in cors_endpoint.lower()
...
def csrf_level14():
    ...
    if request.method == "POST":
        ...
        if websocket_url and ws_protocol and ws_message:
            ...
            if any(
                pattern in websocket_url.lower() or pattern in ws_message.lower()
...
def csrf_level15():
    ...
    if request.method == "POST":
        ...
        if client_id and redirect_uri and state_parameter:
            ...
            if any(
                pattern in redirect_uri.lower() or pattern in state_parameter.lower()
...
def csrf_level18():
    ...
    if request.method == "POST":
        ...
        if graphql_query and operation_name:
            ...
            has_mutation = any(
                pattern in graphql_query for pattern in mutation_patterns
            )
...
def csrf_level20():
    ...
    if request.method == "POST":
        ...
        if mobile_api and device_id and api_key:
            ...
            has_mobile = any(
                pattern in mobile_api.lower() for pattern in mobile_patterns
            )
...
def csrf_level21():
    ...
    if request.method == "POST":
        ...
        if service_name and service_action and auth_token:
            ...
            has_service = any(
                pattern in service_name.lower() for pattern in service_patterns
            )
...
def csrf_level22():
    ...
    if request.method == "POST":
        ...
        if subdomain and target_domain and attack_payload:
            ...
            has_takeover = any(
                pattern in subdomain.lower() for pattern in takeover_patterns
            )
            has_csrf = any(
                pattern in attack_payload.lower() for pattern in csrf_patterns
            )
...
def csrf_level23():
    ...
    if request.method == "POST":
        ...
        if function_url and function_payload and trigger_method:
            ...
            has_serverless = any(
                pattern in function_url.lower() for pattern in serverless_patterns
            )
            has_csrf = any(
                pattern in function_payload.lower() for pattern in csrf_patterns
            )
...
if __name__ == "__main__":
    ...
    if "--reset" in sys.argv:
        reset_database()
        print(
            "Database has been reset. Start the application normally without --reset to use it."
        )
        sys.exit(0)
    ...
    # Check if port was specified via command line argument
    cli_port = None
    if len(sys.argv) > 1 and hasattr(args, "port") and args.port is not None:
        cli_port = args.port

    port = cli_port or int(os.environ.get("PORT", 5000))
